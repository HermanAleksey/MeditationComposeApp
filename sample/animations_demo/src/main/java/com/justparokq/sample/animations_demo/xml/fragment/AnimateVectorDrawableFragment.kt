 ...
 * Use the [AnimateVectorDrawableFragment.newInstance] factory method to
...
class AnimateVectorDrawableFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AnimateVectorDrawableFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AnimateVectorDrawableFragment().apply {
