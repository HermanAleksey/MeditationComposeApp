object Dependencies {
    ...
    const val lifecycle_runtime_ktx =
        "androidx.lifecycle:lifecycle-runtime-ktx:${LibVersions.lifecycle_runtime_ktx_version}"
    const val activity_compose =
        "androidx.activity:activity-compose:${LibVersions.activity_ktx_version}"
    const val androidx_legacy_support =
        "androidx.legacy:legacy-support-v4:${LibVersions.legacy_support_version}"
    ...
    const val compose_ui_test_manifest =
        "androidx.compose.ui:ui-test-manifest:${LibVersions.compose_ui_test_version}"
    const val compose_ui_test_junit4 =
        "androidx.compose.ui:ui-test-junit4:${LibVersions.compose_ui_test_version}"
    const val ui_test = "androidx.ui:ui-test:${LibVersions.compose_ui_test_version}"

    //exo player
    const val exoplayer_core =
        "com.google.android.exoplayer:exoplayer-core:${LibVersions.exoplayer_version}"
